...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_4__["mapState"])({
    errorCode: function errorCode(state) {
  ...
  created: function created() {
    ...
    this.$store.commit("process/setLoading", true); //  hook the progress bar to start before we move router-view
    ...
    this.$router.beforeEach(function (to, from, next) {
      ...
      _this.$store.commit("process/setLoading", true); //  continue to next page
    ...
    this.$router.afterEach(function (to, from) {
      _this.$store.commit("process/setLoading", false);
    });
  }
});
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.$store.commit("process/setLoading", true);
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _this2.$store.commit("process/setLoading", true); // authストアのloginアクションを呼び出す
        ...
        switch (_context.prev = _context.next) {
          ...
          case 2:
            new vue__WEBPACK_IMPORTED_MODULE_2___default.a({
              ...
              template: "<App />",
              methods: {
                progressFinish: function progressFinish() {
  ...
  routes: [{
    ...
    beforeEnter: function beforeEnter(to, from, next) {
      if (_store__WEBPACK_IMPORTED_MODULE_6__["default"].getters["auth/check"]) {
        next("/");
        _store__WEBPACK_IMPORTED_MODULE_6__["default"].commit("process/setLoading", false);
      } else {
        next();
      }
    }
...
/* harmony import */ var _process__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./process */ "./resources/js/store/process.js");
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  modules: {
    ...
    process: _process__WEBPACK_IMPORTED_MODULE_4__["default"],
...
__webpack_require__(/*! E:\laravel\vuesplash\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! E:\laravel\vuesplash\resources\sass\app.scss */"./resources/sass/app.scss");
